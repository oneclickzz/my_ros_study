...
### [yh_turtle](./yh_turtle)
- yh_turtle 패키지 생성
- turtle_patrol, turtle_keyboard, turtle_clear, turtle_keyboard_clear, turtle_patrol.py, turtle_keyboard.py, turtle_clear.py, turtle_keyboard_clear.py
...
- 키보드 입력을 /cmd_vel 토픽의 geometry_msgs/Twist 메시지로 publish하는 노드
- 설치
```bash
